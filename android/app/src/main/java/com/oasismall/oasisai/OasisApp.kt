...
class OasisApp : Application() {
    ...
    val visioProMediaImporter: com.oasismall.oasisai.domain.transfer.VisioProMediaImporter by lazy {
        com.oasismall.oasisai.domain.transfer.VisioProMediaImporter(this)
    }
